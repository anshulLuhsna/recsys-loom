...
| LightGBM slower schedule | lower lr + more trees beats the 300/0.05 schedule | lr=0.03, 500 trees | 0.02799 vs baseline 0.02707 | not inspected | pending | +0.00092; wait for remaining trials before freeze | pending |
| LightGBM min_child | less/more regularization helps | min_child 20 / 100 | 0.02600 / 0.02639 | not inspected | reject so far | both below baseline | pending |
