...
| listwise reranker | set-attention ListNet on a LambdaRank shortlist beats trees | shortlists 25/50/100 | no MAP; signal 11 on fold 1 | not inspected | reject | unmeasured after OOM; keep no reranker | pending |
